    ...
    return (
        <SectionBase id="1">
            <div className="flex-1 overflow-hidden h-screen relative">
                ...
                <Floater top={"513px"} left={"302px"} width={115} image={splash4} delay={"560ms"} duration={"8.16401s"} />
                <Floater top={"328px"} left={"393px"} width={117} image={splash6} delay={"77ms"} duration={"7.14806s"} />
                <Floater top={"-108px"} left={"200px"} width={153} image={splash2} delay={"476ms"} duration={"8.16461s"} />
                <Floater top={"177px"} left={"230px"} width={91} image={splash3} delay={"605ms"} duration={"7.51597s"} />
                <Floater top={"254px"} left={"110px"} width={205} image={geo5} delay={"200ms"} duration={"6.91925s"} />
                <Floater top={"777px"} left={"668px"} width={205} image={splash5} delay={"280ms"} duration={"5.76777s"} />
                <Floater top={"444px"} left={"616px"} width={205} image={splash5} delay={"312ms"} duration={"6.19494s"} />
                <Floater top={"-58px"} left={"584px"} width={205} image={geo1} delay={"731ms"} duration={"5.56368s"} />
        ...
        <>
            ...
            <div className='flex gap-5 content-end'>
                <a className='leading-none'>
                    <span className='font-semibold font-worksans uppercase text-[15px] text-darkblue tracking-widest'>Scopri di più</span>
                </a>
